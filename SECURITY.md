...
**[Report a vulnerability](https://github.com/iasolanki/k8said/security/advisories/new)**
...
k8said is a CLI tool that reads from your local kubeconfig and calls the Anthropic API. It does not expose any network services and does not store credentials. The primary attack surfaces are:
